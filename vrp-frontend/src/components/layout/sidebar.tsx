...
import { Boxes, Map, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          onClick={onToggle}
          className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-slate-300 transition hover:bg-white/10 hover:text-white"
        >
