...
export function DesktopShell(props: ShellProps) {
  ...
  return (
    <div className="min-h-screen px-4 py-4 md:px-6">
      <div className="mx-auto flex max-w-[1820px] gap-4">
        <Sidebar
          active={activeView}
        ...
        <div className="min-w-0 flex-1 space-y-4">
          ...
          <Card className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <div className="mt-2 text-xl font-semibold text-white">{currentFocus}</div>
            </div>
            <div className="flex flex-wrap gap-3">
              <Button variant="secondary" className="gap-2" onClick={loadWorkspace}>
                <FolderOpen size={16} />
                Load workspace
              </Button>
              <Button variant="secondary" className="gap-2" onClick={saveWorkspace}>
                <Save size={16} />
                Save workspace
              </Button>
              ...
              <Button className="gap-2" disabled={!project || !matrix}>
                <WandSparkles size={16} />
                Ready after matrix
              </Button>
              <Button variant="ghost" className="gap-2" onClick={() => setInspectorOpen((value) => !value)}>
